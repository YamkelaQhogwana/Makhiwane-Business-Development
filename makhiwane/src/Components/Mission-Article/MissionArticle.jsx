       ...
       <article className="who-we-are">
          ...
          <section className="mission-article-content">
            ...
            <article className="mission-article-writing-and-button">
                <section className="">
                    <h3>OUR MISSION</h3>
                    <p>Our aim is to cultivate business management for all SMMEs in product manufacturing and service providers so that they are able to distinguish between self-employment and being entrepreneurs or intrapreneurs</p>
                </section>
                <section className="">
                    <h3>OUR VISION</h3>
                    <p>We aim to be the best SMME incubators, business rescuers/coaches for boosting competitiveness and fierce market penetration of all our customers. With a strong stance on our company values in line with our motto, we are committed to the best business-to-business relationships, producing the best value for profitability.
