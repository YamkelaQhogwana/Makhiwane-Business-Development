          ...
          <section className="mission-article-content">
            ...
            <article className="mission-article-writing-and-button">
                <section className="">
                    ...
                    <p>Makhiwane may be described as a Xhosa term that refers to the art of humanity or ubuntu, namely building each other up. It is derived from the Xhosa word "ukwakha" meaning building something up, and may be described as a call for humans to start pouring into the journeys of those around them. 
